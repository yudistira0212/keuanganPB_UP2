                                    ...
                                    @foreach ($ArsipSpm as $index => $data)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                ...
                                                <!-- View -->
                                                <form action="{{ route('download-file-gu', $data->id) }}" method="GET"
                                                ...
                                                <!-- Delete -->
                                                <form action="{{ route('delete-file-all', $data->id) }}" method="POST"
                                                    style="display:inline;"
