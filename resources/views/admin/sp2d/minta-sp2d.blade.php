        ...
        <div class="col-sm-4">
            <div class="page-header float-left">
                <div class="page-title">
                    <h1>Form Permintaan SP2D</h1>
                </div>
            </div>
        </div>
    </div>
    <!-- General Form Elements -->
    <form action="{{ route('PermintaanSP2D-store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body" style="height: 480px; overflow-y: auto;">
                                ...
                                <div class="row mb-3">
                                    <label
                                        class="col-sm-3 col-form-label text-center font font-italic font-weight-bold">Upload
                                        Berkas</label>
                                </div>
                                <hr>
                                <div class="row mb-3">
                                    <label for="inputDinas" class="col-sm-2 col-form-label">Berkas SPM</label>
                                    <div class="col-sm-10">
                                        <input name="file" type="file"
                                            class="form-control filter-notifikasi select2 @error('jumlah_uang') is-invalid @enderror"
