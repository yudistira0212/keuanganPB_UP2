...
class ArspmupController extends Controller
{
    public function index()
    {
        $userID = Auth::id();
        $ArsipSpm = SpmArsip::where('jenis', 'UP')->where('user_id', $userID)->get();
        return view('admin.arsip.arsip_spm.arsip_spm_up', compact('ArsipSpm'));
    }
    ...
    public function deleteFile($id)
    {
        ...
        return redirect()->route('arspm-up')->with('success', 'File berhasil dihapus');
    }
}
