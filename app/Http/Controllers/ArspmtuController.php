...
class ArspmtuController extends Controller
{
    public function index()
    {
        $userID = Auth::id();
        $ArsipSpm = SpmArsip::where('jenis', 'TU')->where('user_id', $userID)->get();
        return view('admin.arsip.arsip_spm.arsip_spm_tu', compact('ArsipSpm'));
    }
    ...
    public function deleteFile($id)
    {
        ...
        return redirect()->route('arspm-tu')->with('success', 'File berhasil dihapus');
    }
}
