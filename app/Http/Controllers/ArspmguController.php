...
class ArspmguController extends Controller
{
    public function index()
    {
        $userID = Auth::id();
        $ArsipSpm = SpmArsip::where('jenis', 'GU')->where('user_id', $userID)->get();
        return view('admin.arsip.arsip_spm.arsip_spm_gu', compact('ArsipSpm'));
    }
    ...
    public function deleteFile($id)
    {
        ...
        return redirect()->route('arspm-gu')->with('success', 'File berhasil dihapus');
    }
}
